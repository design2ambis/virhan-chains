                            ...
                            <div className="col-xxl-6">
                                <div className="single-product-info">
                                    ...
                                    <div className="pricing mt-4">
                                        ...
                                        <span className="primary-text-color">{product.design_weight}</span>
                                    </div>
                                    ...
                                    <ul className="product-meta mt-32">
                                        ...
                                        <li>Categories: {product.category_name} - {product.sub_cat_name}</li>
                        ...
                        {ran.map((r, index) => (
                            <div className="ur-product-card col-md-2 col-sm-12" key={index}>
                                ...
                                >
                                    ...
                                    <span className="primary-text-color fs-sm fw-medium">Weight: {r.design_weight}</span>
                                </div>
                            </div>
                        ))}
                    </div>
