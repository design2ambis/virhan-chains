            ...
            >
                <div className="container">
                    <p className="breadcrumb-text fw-light mb-0">
                        <Link to="/">Home</Link>
                        <span className="primary-text-color">Shop / {cat.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')} / {subcat.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')} </span>
                    </p>
                </div>
            </div>
