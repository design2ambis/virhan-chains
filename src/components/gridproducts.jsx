...
const Gridproducts = (props) => {
    ...
    document.title = `Virhan Chains - ${props.cat.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')} | ${props.subcat.split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}`;
        ...
        if (token && token != null && token != "") {
            ...
            try {
                const cartraw = await fetch(
                    `https://nivsjewels.com/api/update`, {
                    method: 'POST',
                                                                    ...
                                                                    <div className="feature-image d-flex align-items-cneter justify-content-center light-bg position-relative">
                                                                        ...
                                                                        <div className="product-overlay position-absolute">
                                                                            <div className="product-btns d-flex align-items-center justify-content-between">
                                                                                ...
                                                                                <button type="button"
                                                                                    onClick={() => addCart(pro.id, pro.image, pro.jewelcat, pro.no, pro.size, pro.weight)}
                                                                                >
                                                                                    <i className="fa-solid fa-basket-shopping" />
                                                                                </button>

                                                                                <Link to={`/product/${pro.no}`} className="#product_quickview">
